        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('Racesboard.update', ['race' => $Races->id]) }}">
                        @csrf
                        <!-- Voornaam -->
                        <div class="mt-4">
                            <x-input-label for="title" :value="__('title')" />
                            <x-text-input id="title" class="mt-1 block w-full" type="text" name="title" :value="$Races->title" :placeholder="$Races->title" required autofocus autocomplete="title" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="description" class="mt-1 block w-full" type="text" name="description" :value="$Races->description" :placeholder="$Races->description" required autocomplete="description" />
                        ...
                        <div class="mt-4">
                            ...
                            <select name="format" id="format" :placeholder="$Races - > format" class="mt-1 block w-full text-black" required autocomplete="format">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="location" class="mt-1 block w-full" type="text" name="location" :value="$Races->location" :placeholder="$Races->location" required autocomplete="location" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="date" class="mt-1 block w-full" type="date" name="date" :value="$Races->date" :placeholder="$Races->date" required autocomplete="date" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="racers" :value="__('racers')" />
                            <select multiple name="racers[]" id="racers" :value="$Races->racers" class="mt-1 block w-full text-black" required autocomplete="racers">
                        ...
                        <div class="mt-4">
                            ...
                            <select multiple id="selected-racers" :value="$Races->racers" class="mt-1 block w-full text-black" required disabled>
